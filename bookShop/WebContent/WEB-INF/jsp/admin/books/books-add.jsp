...
<![endif]-->
<!--/meta 作为公共模版分离出去-->
<title>新增书籍 - 书籍管理 </title>
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal" action="${pageContext.request.contextPath }/addBook" id="form" method="post" enctype="multipart/form-data" onsubmit="return check()">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>书籍名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="bookName" />
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="publisher" class="select">
					...
					<option value="茂名出版社">茂名出版社</option>
					<option value="广东石油化工学院出版社">广东石油化工学院出版社</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
			<textarea name="describes" class="common-textarea" id="editor" cols="30" style="width:98%;height:400px;" required rows="10"></textarea>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button id="submit" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i>添加</button>
