...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-6 column">
			<img alt="后台登录" src="images/adminLogin.jpg" class="img-rounded img-responsive"  />
		</div>
		<div class="col-md-6 column">
		<div class="row clearfix">
				...
				<div class="col-md-8 column">
					<form role="form" method="POST" action="${pageContext.request.contextPath}/adminLoginCheck">
						
						<h2 class="text-center"><font color="red"><b>书店后台登录</b></font></h2><br>
						
							<div class="form-group">
								 <label for="exampleInputEmail1">用户名</label><input type="text" class="form-control" id="exampleInputEmail1" name="adminName"/>
							</div>
							<div class="form-group">
